...
import model_customconv

# Set seed for reproducibility
torch.manual_seed(42)

# Initialize the Orion scheme, model, and data
scheme = orion.init_scheme("../../configs/customconv.yml")
trainloader, testloader = get_fashionMnist_datasets(data_dir="../data", batch_size=1)
net = model_customconv.LargeConvNet()

# Train model (optional)
device = "cuda" if torch.cuda.is_available() else "cpu"
train_on_fashionMnist(net, data_dir="../data", epochs=5, device=device)
